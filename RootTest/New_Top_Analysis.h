...
// Thu Feb  7 14:22:55 2019 by ROOT version 6.06/08
// from TTree nominal/tree
// found on file: /usr/local/share/physics/labs/y2/projects/MiriamWatson/ttbar.root
//////////////////////////////////////////////////////////

#ifndef New_Top_Analysis_h
#define New_Top_Analysis_h
...
class New_Top_Analysis : public TSelector {
public :
   ...
   New_Top_Analysis(TTree * /*tree*/ =0) { }
   virtual ~New_Top_Analysis() { }
   ...
   ClassDef(New_Top_Analysis,0);

};

#endif

#ifdef New_Top_Analysis_cxx
void New_Top_Analysis::Init(TTree *tree)
{
...
Bool_t New_Top_Analysis::Notify()
{
...
#endif // #ifdef New_Top_Analysis_cxx
